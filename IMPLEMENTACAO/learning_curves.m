...
%    plot_cost(rlcost_test', rlcost_train', 'Curva de aprendizado para a Regressao Linear');
	...
	csvwrite("rn1cost_test.csv", rn1cost_test');
    csvwrite("rn1cost_train.csv", rn1cost_train');
    csvwrite("rn2cost_test.csv", rn2cost_test');
    csvwrite("rn2cost_train.csv", rn2cost_train');
