...
load('ex05_pesos2.mat');
rna_params = [Theta1(:) ; Theta2(:) ; Theta3(:) ];
...
J = rnaCusto2(rna_params, input_layer_size, hidden_layer_size, hidden_layers, num_labels, X, y, 0);
...
J = rnaCusto2(rna_params, input_layer_size, hidden_layer_size, hidden_layers,...
...
initial_Theta2 = inicializaPesosAleatorios(hidden_layer_size, hidden_layer_size);
initial_Theta3 = inicializaPesosAleatorios(hidden_layer_size, num_labels);
...
debug_J  = rnaCusto2(rna_params, input_layer_size, ...
                          hidden_layer_size, hidden_layers, num_labels, X, y, lambda);
...
Theta1 = reshape(rna_params(comeco_camada_1:fim_camada_1), ...
                 hidden_layer_size, (input_layer_size + 1));
                 
Theta2 = reshape( rna_params( comeco_camada_2:fim_camada_2), ...
                 hidden_layer_size, hidden_layer_size + 1);
                 
Theta3 = reshape( rna_params(comeco_camada_3:fim_camada_3),...
...
pred = predicao2(Theta1, Theta2, Theta3, X);
